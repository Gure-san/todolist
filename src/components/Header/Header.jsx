...
function Header({ appData, dispatchApp }) {
  ...
  if (theme === THEME_VARIANTS.DARK_MODE) {
    ...
    styleAppConfigBtns =
      "dark:bg-secondary-100 dark:hover:bg-secondary-150 dark:border-secondary-150 dark:shadow-primary dark:shadow-[inset_0px_0px_1rem_bg-primary]";
  }
  ...
  if (theme === THEME_VARIANTS.LIGHT_MODE) {
    ...
    styleAppConfigBtns =
      "bg-tertiary-100 hover:bg-tertiary-150  border-tertiary-150 shadow-tertiary-150 shadow-[inset_0px_0px_1rem_bg-tertiary-150]";
  }

  return (
    <section className="bg-inherit flex justify-between items-center py-8">
      {/* Brand Name / App Name */}
      <div className="">
        {theme === THEME_VARIANTS.DARK_MODE ? <BrandDark /> : <BrandLight />}
      </div>
      ...
      <div>
        ...
        >
          <img src={srcThemeToggle} height={HEIGHT_ICON} width={WIDTH_ICON} />
        </button>
